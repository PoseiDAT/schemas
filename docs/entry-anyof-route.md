...
```txt
https://poseidat.org/schema/entry/route.json#/anyOf/6
```
...
`object` ([Route](entry-anyof-route.md))

# 6 Properties

| Property                          | Type          | Required | Nullable       | Defined by                                                                                                            |
| :-------------------------------- | :------------ | :------- | :------------- | :-------------------------------------------------------------------------------------------------------------------- |
| [journal_id](#journal_id)         | `string`      | Required | cannot be null | [Route](route-properties-journal_id.md "https://poseidat.org/schema/entry/route.json#/properties/journal_id")         |
| [entry_id](#entry_id)             | `string`      | Required | cannot be null | [Route](route-properties-entry_id.md "https://poseidat.org/schema/entry/route.json#/properties/entry_id")             |
...
| [entry_datetime](#entry_datetime) | `string`      | Optional | cannot be null | [Route](route-properties-entry_datetime.md "https://poseidat.org/schema/entry/route.json#/properties/entry_datetime") |
| [revision](#revision)             | `string`      | Required | cannot be null | [Route](route-properties-revision.md "https://poseidat.org/schema/entry/route.json#/properties/revision")             |
| [immutable](#immutable)           | `boolean`     | Required | cannot be null | [Route](route-properties-immutable.md "https://poseidat.org/schema/entry/route.json#/properties/immutable")           |
| [remarks](#remarks)               | `string`      | Optional | cannot be null | [Route](route-properties-remarks.md "https://poseidat.org/schema/entry/route.json#/properties/remarks")               |
...
| Additional Properties             | Not specified | Optional | cannot be null | [Route](route-additionalproperties.md "https://poseidat.org/schema/entry/route.json#/additionalProperties")           |
...
*   defined in: [Route](route-properties-journal_id.md "https://poseidat.org/schema/entry/route.json#/properties/journal_id")
...
*   defined in: [Route](route-properties-entry_id.md "https://poseidat.org/schema/entry/route.json#/properties/entry_id")
...
*   defined in: [Route](route-properties-entry_datetime.md "https://poseidat.org/schema/entry/route.json#/properties/entry_datetime")
...
*   defined in: [Route](route-properties-revision.md "https://poseidat.org/schema/entry/route.json#/properties/revision")
...
*   defined in: [Route](route-properties-immutable.md "https://poseidat.org/schema/entry/route.json#/properties/immutable")
...
*   defined in: [Route](route-properties-remarks.md "https://poseidat.org/schema/entry/route.json#/properties/remarks")
...
*   defined in: [Route](route-additionalproperties.md "https://poseidat.org/schema/entry/route.json#/additionalProperties")
