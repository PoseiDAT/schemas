...
```txt
https://poseidat.org/schema/core/measurement/fish-sorting.json
```
...
## A fish sorting detection measurement Type

`object` ([A fish sorting detection measurement](fish-sorting.md))

# A fish sorting detection measurement Properties
