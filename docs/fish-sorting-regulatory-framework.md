...
```txt
https://poseidat.org/schema/core/measurement/fish-sorting-regulatory-framework.json
```
...
## The regulatory framework for fish sorting measurements Type

`object` ([The regulatory framework for fish sorting measurements](fish-sorting-regulatory-framework.md))

# The regulatory framework for fish sorting measurements Properties
