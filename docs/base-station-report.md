...
*   defined in: [Position report AIS](base-station-report-properties-ais_message_type.md "https://poseidat.org/schema/core/ais-message/base-station-report.json#/properties/ais_message_type")
