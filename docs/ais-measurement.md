...
| [message_type](#message_type)                             | `string` | Required | cannot be null | [AIS measurement value](ais-measurement-properties-ais-message-types-1.md "https://poseidat.org/schema/enum/ais/ais-message-type.json#/properties/message_type")                                  |
