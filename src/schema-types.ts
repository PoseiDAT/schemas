...
export interface IMeasurementMeasurementValue {
  ...
  /** A text measurement */ text?: IMeasurementText;
...
export interface IMeasurementText {
  /** The string value send by the sensor */ value: string;
}
...
export type IEnumMeasurementType = "ACCELERATION" | "ANGULAR_VELOCITY" | "CURRENT" | "DEPTH" | "ENERGY_CONSUMPTION" | "FORCE" | "FUEL_CONSUMPTION" | "HUMIDITY" | "MAGNETISM" | "ONOFF" | "POSITION" | "POWER" | "PRESSURE" | "ROUTE" | "RPM" | "SCALE" | "SPATIAL_AXES" | "SPEED" | "SUBSURFACE" | "TEMPERATURE" | "TRAWL_TENSION" | "VOLTAGE" | "SPEEDLOG" | "WEATHER" | "NMEA";
