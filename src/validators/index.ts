...
// Backwards-compatible aliases for names previously generated by jsonschema-to-typings.
export type { ICoreEquipmentDevice as IEquipmentDevice } from './core/equipment/device';
